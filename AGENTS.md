...
- Every code or release change must increment or confirm the app version and keep `package.json`, `package-lock.json`, `src/core/version.js`, the Settings page version display, the About modal, and the README heading synchronized.
