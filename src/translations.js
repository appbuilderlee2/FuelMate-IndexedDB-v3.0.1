// --- TRANSLATIONS ---
        const translations = {
            en: {
                ...
                range_month: 'Month', range_year: 'Year', range_all: 'All Time', range_custom: 'Dates', date_filter: 'Date period', date_from: 'From', date_to: 'To', clear_date_range: 'Clear dates',
                ...
                tire_front_pair: 'Front pair', tire_rear_pair: 'Rear pair', tire_all_four: 'All four',
                tire_selected_count: '{n} tires selected', tire_selection_hint: 'The details below apply to every selected tire. The cost is saved once for this replacement event.',
                ...
                tire_recommended: 'Recommended', tire_rotation_route: 'directional rotation route active', tire_custom_swaps: 'Custom pair swaps',
                validation_tire_rotation: 'Please select a valid tire rotation.', validation_tire_position_once: 'Each tire position can only appear once per rotation.', validation_tire_position: 'Select at least one tire position.',
                next_tire_change: 'Next Tire Change',
                tire_not_set: 'Not set',
                tire_brand_unspecified: 'Brand not entered',
                ...
                reminder_vehicle_view: 'Vehicle view', all_vehicles: 'All vehicles',
                ...
                reminder_all: 'All', reminder_need_action: '{n} need attention',
                reminder_overdue: 'Overdue', reminder_due_soon: 'Due soon', reminder_later: 'Later',
                select: 'Select', reminder_empty_title: 'All clear', reminder_empty_desc: 'No reminders match these filters.',
                selected_count: '{n} selected', snoozed_until: 'Snoozed until',
                reminder_details: 'Reminder Details', due_conditions: 'Due conditions', distance_condition: 'Distance condition', date_condition: 'Date condition',
                over_by: 'Over by', remaining: 'Remaining', due_date: 'Due date', source_record: 'Source record', view_source_record: 'View source record',
                reminder_action: 'Reminder action', repeat_rule: 'Repeat rule', not_applicable: 'Not applicable', edit_record: 'Edit record', snooze_again: 'Snooze again',
                years: 'years', months: 'months', days: 'days', days_before: 'days before',
                documents: 'Documents',
                reminder_settings_desc: 'Manage document reminders and due dates.',
                search_placeholder: 'Search notes/location...',
                search_brand_placeholder: 'Search notes/location/brand...',
                has_location: 'Has location', has_notes: 'Has notes',
                vehicle_management: 'Vehicle management', app_settings: 'App settings', fuel_efficiency_trend: 'Fuel efficiency trend',
                ...
                tab_active: 'Pending', offline_mode: 'Offline mode — using local data', back_online: 'Back online', update_available: 'A new version is ready', reload_now: 'Reload',
                tab_snoozed: 'Snoozed',
                tab_done: 'Done',
                unsnooze: 'Unsnooze',
                restore: 'Restore',
                ...
                import_orphan_vehicle: 'Backup contains {n} records without a matching vehicle. Nothing was imported. Repair the file or choose another backup.',
                confirm_backup_saved: 'Check that the backup file is saved on your device. Mark this backup as complete?',
                confirm_import_backup_saved: 'Before replacing your data, confirm that {name} is saved and accessible on your device. Continue?',
                import_autobackup: 'Auto-backup downloaded:',
                import_overwrite: 'Backup & Overwrite',
                units: 'Units', currency: 'Currency', language: 'Language', version: 'Version',
            ...
            zh: {
                ...
                range_month: '月份', range_year: '年份', range_all: '全部', range_custom: '自訂', date_filter: '日期範圍', date_from: '開始日期', date_to: '結束日期', clear_date_range: '清除日期',
                ...
                tire_front_pair: '前兩條', tire_rear_pair: '後兩條', tire_all_four: '四條',
                tire_selected_count: '已選取 {n} 條輪胎', tire_selection_hint: '以下資料會套用到所有已選輪胎；今次更換金額只會記錄一次。',
                tire_brand: '品牌/型號',
                tire_swap: '交換位置',
                tire_swap_a: '由',
                tire_swap_b: '到',
                ...
                tire_alignment: '四輪定位',
                tire_balancing: '平衡',
                tire_recommended: '建議', tire_rotation_route: '方向換位路線已啟用', tire_custom_swaps: '自訂成對交換',
                validation_tire_rotation: '請選擇有效的輪胎換位。', validation_tire_position_once: '每個輪胎位置在一次換位中只可出現一次。', validation_tire_position: '請至少選擇一個輪胎位置。',
                next_tire_change: '下次換胎',
                tire_not_set: '未設定',
                tire_brand_unspecified: '未填品牌',
                ...
                reminder_vehicle_view: '車輛檢視', all_vehicles: '所有車輛',
                ...
                reminder_docs: '證件',
                reminder_backup: '備份',
                reminder_all: '全部', reminder_need_action: '{n} 項需要處理',
                reminder_overdue: '已逾期', reminder_due_soon: '即將到期', reminder_later: '稍後',
                select: '選取', reminder_empty_title: '全部處理完成', reminder_empty_desc: '此篩選沒有提醒。',
                selected_count: '已選取 {n} 項', snoozed_until: '延後至',
                reminder_details: '提醒詳情', due_conditions: '到期條件', distance_condition: '里程條件', date_condition: '日期條件',
                over_by: '已超過', remaining: '剩餘', due_date: '到期日', source_record: '來源記錄', view_source_record: '查看來源記錄',
                reminder_action: '提醒操作', repeat_rule: '重複規則', not_applicable: '不適用', edit_record: '編輯記錄', snooze_again: '再次延後',
                years: '年', months: '個月', days: '天', days_before: '天前',
                documents: '證件',
                reminder_settings_desc: '管理證件提醒與到期日',
                search_placeholder: '搜尋地點/備註...',
                search_brand_placeholder: '搜尋地點／備註／品牌...',
                has_location: '有地點', has_notes: '有備註',
                vehicle_management: '車輛管理', app_settings: '應用程式設定', fuel_efficiency_trend: '油耗趨勢',
                install_guide: '安裝教學',
                ...
                snooze_1d: '延後 1 天',
                snooze_30d: '延後 30 天',
                tab_active: '待辦', offline_mode: '離線模式——正在使用本機資料', back_online: '網絡已恢復', update_available: '新版本已準備好', reload_now: '重新載入',
                tab_snoozed: '已延後',
                tab_done: '已完成',
                unsnooze: '取消延後',
                restore: '還原',
                ...
                import_orphan_vehicle: '備份內有 {n} 筆紀錄找不到對應車輛；尚未匯入任何資料。請修正檔案或選擇另一份備份。',
                confirm_backup_saved: '請先確認備份檔案已儲存到裝置，再標記為完成備份。已確認儲存？',
                confirm_import_backup_saved: '覆蓋資料前，請確認 {name} 已儲存並可在裝置上開啟。確定繼續？',
                import_autobackup: '已下載自動備份：',
                import_overwrite: '備份並覆蓋',
                units: '單位', currency: '貨幣', language: '語言', version: '版本',
